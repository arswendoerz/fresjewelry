...
function Notification() {
  ...
  const notifications = [
    ...
    },
    {
      ...
      details:
        "Your custom Ronce Bracelet will be shipped soon. Check status in your profile.",
  ...
  return (
    <div className="font-poppins container mx-auto w-[90%] md:w-[70%] px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:gap-4">
        <div
          className="flex-1 bg-[#CB9531] text-white p-4 rounded-xl mb-4 md:mb-0 flex items-center h-16 cursor-pointer"
          onClick={() => navigate({ to: `/` })}
        >
          <img
        ...
        <div className="w-full md:w-auto flex justify-center items-center">
          <Select
            className="border border-[#CB9531] rounded-3xl"
            onValueChange={handleSortChange}
          >
            <SelectTrigger className="w-full md:w-auto border-[#CB9531] rounded-3xl text-[#6C4C35]">
              <TbArrowsUpDown size={25} color="#CB9531" />
              <SelectValue className="text-[#CB9531]" placeholder="Sort" />
            </SelectTrigger>
            <SelectContent className="text-[#CB9531] bg-white border border-[#CB9531] rounded-xl">
              <SelectGroup>
                <SelectItem
                  value="latest"
                  className="flex items-center focus:bg-[#CB9531] text-[#CB9531] focus:text-white"
                >
                  Latest
                </SelectItem>
