...
function Account() {
  ...
  return (
    <div className="font-poppins container mx-auto w-[90%] md:w-[70%] px-4 py-8">
      ...
      <div
        className="flex-1 bg-[#85986d] text-white p-4 rounded-xl mb-4 flex items-center h-16"
        onClick={() => navigate({ to: `/` })}
      >
        <img
        ...
        />
        <span className="text-[16px]"><strong>Home</strong></span>
      </div>
      ...
      <div className="flex flex-col lg:flex-row mt-[20px]">
        ...
        <div className="w-full lg:w-4/6">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="mb-4 bg-[#85986d] rounded-t-lg">
              <p className="text-white px-[16px] py-[8px]">Personal Data</p>
            </div>
            <div className="px-[16px]">
              <div className="mb-4">
                <Label className="text-[#6b7a56]">Full Name</Label>
                <Input
              ...
              <div className="mb-4">
                <Label className="text-[#6b7a56]">Telephone Number</Label>
                <Input
                  className="w-full p-2 border border-[#D0D0D0] rounded mt-1"
              ...
              <div className="mb-4">
                <Label htmlFor="email" className="text-[#6b7a56]">Email</Label>
                <Input
                  type="email"
                  id="email"
                  placeholder="Email"
